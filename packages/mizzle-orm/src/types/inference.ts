 ...
 */
type IsOptional<T extends AnyFieldBuilder> = T extends { _config: { optional: true } }
  ? true
  : false;
...
type HasDefault<T extends AnyFieldBuilder> = T extends {
  _config: { defaultValue: any };
}
  ? true
  : T extends { _config: { defaultNow: true } }
    ? true
    : false;
...
type IsAutoGenerated<T extends AnyFieldBuilder> = T extends {
  _config: { isInternalId: true };
}
  ? true
  : T extends { _config: { isPublicId: true } }
    ? true
    : false;
